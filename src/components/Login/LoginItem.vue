<template>
  <div class="login-box">
    <el-tabs class="login-box-tabs">
      ...
      <el-tab-pane label="账号密码登陆" :class="{ on: isPassWordLogin }"
            @click="isPassWordLogin = true"></el-tab-pane>
      <el-tab-pane label="手机短信登陆" :class="{ on: !isPassWordLogin }"
            @click="isPassWordLogin = false"></el-tab-pane>
    </el-tabs>
    <!-- 账号登录 -->
    <div class="login-box-account" :class="{ on: isPassWordLogin }">
      <el-form
        :model="ruleForm"
        status-icon
        :rules="rules"
    ...
    <!-- 手机登录 -->
    <div class="login-box-phone" style="display : none" :class="{ on: !isPassWordLogin }">
      <el-form
        :model="ruleForm"
        status-icon
        :rules="rules"
...
.login-box {
  ...
  .login-box-account,.login-box-phone {
    // background pink
    margin-bottom: 50px;
